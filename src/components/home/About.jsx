...
const About = () => {
    return (
        <section className="bg-base-100 font-open">
            ...
            <p className="mt-3 font-open text-center">En Portamedallas, entendemos que cada medalla cuenta una historia de esfuerzo, dedicación y logros en el mundo del deporte. Es por eso que ofrecemos una amplia variedad de portamedallas diseñados para satisfacer  las necesidades de los atletas de todas las disciplinas.</p>
            <p className="mt-2 text-center">Con <strong>más de 20 deportes</strong> representados en nuestra colección, estamos  comprometidos a ayudarte a exhibir con orgullo tus logros deportivos.</p>
